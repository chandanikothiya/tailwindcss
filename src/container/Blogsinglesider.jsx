...
import { IoArrowUndoOutline, IoCalendarOutline } from "react-icons/io5";
import { PiMagnifyingGlassBold, PiQuotes } from "react-icons/pi";
import { RiGoogleLine } from "react-icons/ri";
import { NavLink } from "react-router-dom";

function Blogsinglesider() {
    return (
        <main>
            ...
            <section id="blogsidergrid">
                <div className="containercust">
                    <div className="grid grid-cols-12 gap-y-15 min-[992px]:gap-y-0 min-[992px]:gap-x-8 ">
                        <div className="col-span-12 min-[992px]:col-span-8 grid grid-cols-12">
                            <div className="col-span-12  border-1 border-gray-200">
                            ...
                            <div className="postcomment mt-10 col-span-12">
                                <div className="siderbar-card col-span-12 min-[992px]:col-span-10 min-[992px]:col-start-2">
                                    ...
                                    <div>
                                        ...
                                        <hr className="md:w-[360px] lg:w-[400px]  xl:w-[600px] ml-auto text-gray-200 my-6" />

                                        <div className="reply flex gap-x-9 mb-6 md:w-[360px] lg:w-[400px]  xl:w-[600px] ml-auto mt-10 flex-wrap md:flex-nowrap gap-y-4 md:gap-y-0">
                            ...
                            <div className="commentform mt-[40px] col-span-12">
...
export default Blogsinglesider;