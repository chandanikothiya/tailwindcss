            ...
            bg-center h-[236px] min-[768px]:h-[256px] min-[992px]:h-[366px] !my-0  pt-[120px] pb-[50px] min-[992px]:pt-[180px] min-[992px]:pb-[100px]">
                <div className="containercust">
                    <div className="breadcrumbs text-white text-center">
                        <h1 className="text-[25px] md:text-[32px] font-merriweather font-bold" >Login</h1>
            ...
            <section id="registration-form">
                <div className="containercust">
                    <div className="grid grid-cols-12 ">
                        <form action="" className="col-span-12 min-[768px]:col-span-10 min-[992px]:col-span-8  lg:col-span-6 min-[768px]:col-start-2 min-[992px]:col-start-3 lg:col-start-4 
                         border-t-4 border-t-[#006838] p-[30px] md:p-[50px] shadow-lg  ">
                            <h4 className="text-[22px] md:text-[24px] font-merriweather font-[500] text-center">Login To Your Account</h4>

                            <input type="text" name="email" id="email" placeholder="Email" className="mt-8" />
                            ...
                            <div className="checkbox flex items-center justify-between">
                                <div>
                                    ...
                                    />
                                    <label className="text-[#838181] ml-3">Remember me</label>
                                </div>

                                <div>
                                    <a href="#" className="hover:text-[#88C250] hover:underline text-[#838181]">Lost your password?</a>
                                </div>
                            </div>

                            <button className="btn sm:py-3 min-[992px]:!py-[14px] !w-full !mt-8 !mb-0">
                                Registration
                            </button>
                            ...
                            <div className="form-social grid grid-cols-12 md:gap-x-6 gap-y-3 md:gap-y-5 my-7 md:my-10 !mt-0">
                            ...
                            <p className="font-poppins text-[14px] text-gray-500 text-center mt-4">
                                Don't have an account? <NavLink to={'/signup'} className="text-[#006838] hover:underline">Register here</NavLink>
                            </p>
                        </form>
                    </div>
                </div>
